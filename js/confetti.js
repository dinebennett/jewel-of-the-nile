    ...
    $(function() {
        ...
        var colorThemes = [
            ...
            function() {
                ...
                return color(256, black, black);
            },
            function() {
                var black = 256 * random() | 0;
                return color(black, 256, black);
            },
            function() {
                var black = 256 * random() | 0;
                return color(black, black, 256);
            },
            function() {
                return color(256, 100, 256 * random() | 0);
            },
            function() {
                return color(256 * random() | 0, 256, 256);
            },
            function() {
                var black = 256 * random() | 0;
